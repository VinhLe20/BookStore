...
class _PaymentState extends State<Payment> {
  ...
  Future addOrder(String total) async {
    ...
    print(User.id);
    print(total);
    http.post(Uri.parse('http://192.168.1.8/addOrder.php'), body: {
      'id': id,
      'total': total,
      'user_id': User.id,
  ...
  Future addOrderDetail(
    ...
    http.post(Uri.parse('http://192.168.1.8/addOrderDetail.php'), body: {
  ...
  Future deleteProduct(String productId) async {
    final uri = Uri.parse('http://192.168.1.8/deleteproducts.php');
                            ...
                            return Row(
                              children: [
                                Container(
                                  ...
                                  width: 100,
                                  child: Image.network(
                                      'http://192.168.1.8/uploads/${widget.products[index]['image']}'),
                                ),
                                Padding(
