...
class _ProductDetailState extends State<ProductDetail> {
  ...
  Future<List> loadDataComment() async {
    final uri = Uri.parse('http://192.168.1.13:8012/getdataComment.php');
  ...
  Future addCart(String oder_id, String product_id, String quantity) async {
    final uri = Uri.parse('http://192.168.1.13:8012/addCart.php');
  ...
  Future addCartDetail(
    ...
    final uri = Uri.parse('http://192.168.1.13:8012/addCartDetail.php');
    http.post(uri, body: {
      'cart_id': oder_id,
      'product_id': product_id,
      'quantity': quantity,
  ...
  Future<bool> loadCart(String product_id) async {
    final uri = Uri.parse('http://192.168.1.13:8012/getCartDetail.php');
    var response = await http.get(uri);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.network(
              'http://192.168.1.13:8012/uploads/${widget.product['image']}',
